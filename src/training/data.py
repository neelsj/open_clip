...
def get_csv_dataset_extra(args, preprocess_fn, is_train, epoch=0, tokenizer=None, extra=False):
    input_filename = args.train_data if is_train else args.val_data
    assert input_filename

    dataset = CsvDatasetExtra(
        input_filename,
        preprocess_fn,
        img_key=args.csv_img_key,
        caption_key=args.csv_caption_key,
...
def get_dataset_fn(data_path, dataset_type):
    ...
    elif dataset_type == "csv_extra":
        return get_csv_dataset_extra
